...
public class OAuth2Provider extends OServerPluginAbstract implements
	...
	@Override
	public void config(final OServer oServer,
	...
	@Override
	public void callback(OHttpRequest iRequest, OHttpResponse iResponse)
	    throws IOException {
		URL url = new URL(tokenUrl);
		String payload = "code=" + iRequest.getParameter("code") + "&client_id="
		...
		InputStream stream = (conn.getResponseCode() == OHttpUtils.STATUS_OK_CODE) ? conn
		...
		reader.close();
		iResponse.send(OHttpUtils.STATUS_OK_CODE, "OK",
		    OHttpUtils.CONTENT_TEXT_PLAIN, sb.toString(), null);
	}
